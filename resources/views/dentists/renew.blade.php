        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-700 overflow-hidden shadow-sm sm:rounded-lg p-6 transition-colors duration-200">
                ...
                <div class="mb-6 border-b border-gray-100 dark:border-gray-600 pb-4">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Log New Fiscal Subscription</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400">PRC License Number: <span class="font-mono font-bold text-gray-700 dark:text-gray-300">{{ $dentist->prc_no }}</span></p>
                </div>
                ...
                <form action="{{ route('dentists.storeRenewal', $dentist->id) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input list="year-options"
                               ...
                               class="mt-1 block w-full rounded-md shadow-sm transition duration-150 ease-in-out text-sm dark:text-gray-100 dark:bg-gray-800 @error('membership_year') border-red-300 focus:border-red-500 focus:ring-red-500 @else border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 @enderror">
                    ...
                    <div>
                        ...
                        <select name="payment_status" id="payment_status" required
                                class="mt-1 block w-full rounded-md shadow-sm transition duration-150 ease-in-out text-sm dark:text-gray-100 dark:bg-gray-800 @error('payment_status') border-red-300 focus:border-red-500 focus:ring-red-500 @else border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 @enderror">
