...
=======
            <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 text-gray-900 dark:text-gray-100">
                ...
                <div class="mb-6 border-b border-gray-100 dark:border-gray-800 pb-4">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">Modify Professional Record</h3>
...
=======
                    <!-- Profile Image Management Section -->
                    <div class="bg-gray-50 dark:bg-gray-800 p-4 rounded-xl border border-gray-100 dark:border-gray-700 flex flex-col sm:flex-row items-center gap-4">
                        <div class="shrink-0">
                            @if($dentist->profile_image)
                                <img src="{{ asset('storage/' . $dentist->profile_image) }}" alt="Current Profile" class="w-20 h-20 rounded-full object-cover border-2 border-indigo-100 dark:border-indigo-900 shadow-sm">
                            @else
                                <div class="w-20 h-20 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-gray-400 dark:text-gray-300 text-2xl shadow-inner">📸</div>
>>>>>>> 2ef7221 (Refactor dentist CRUD views for dynamic light/dark mode, fix email binding in edit view, and remove photo column from directory index)
                            @endif
                        </div>
                        <div class="w-full">
...
=======
                            ...
                            <input type="file" 
                                   ...
                                   id="profile_image"
                                   accept="image/jpeg, image/png, image/jpg"
                                   class="mt-1 block w-full text-sm text-gray-500 dark:text-gray-400 file:mr-4 file:py-1.5 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 dark:file:bg-gray-700 file:text-indigo-700 dark:file:text-indigo-300 hover:file:bg-indigo-100 dark:hover:file:bg-gray-600 transition">
                            
                            <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">Accepted Formats: JPEG, JPG, or PNG (Max size: 10MB). Leave empty to keep the current image.</p>
                            @error('profile_image') <p class="text-red-500 dark:text-red-400 text-xs mt-1 font-medium">⚠️ {{ $message }}</p> @enderror
>>>>>>> 2ef7221 (Refactor dentist CRUD views for dynamic light/dark mode, fix email binding in edit view, and remove photo column from directory index)
                        </div>
                    </div>
...
=======
                            ...
                            @error('full_name') <p class="text-red-500 dark:text-red-400 text-xs mt-1 font-medium">⚠️ {{ $message }}</p> @enderror
>>>>>>> 2ef7221 (Refactor dentist CRUD views for dynamic light/dark mode, fix email binding in edit view, and remove photo column from directory index)
                        </div>
...
=======
                                   class="mt-1 block w-full rounded-md bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                            @error('prc_no') <p class="text-red-500 dark:text-red-400 text-xs mt-1 font-medium">⚠️ {{ $message }}</p> @enderror
>>>>>>> 2ef7221 (Refactor dentist CRUD views for dynamic light/dark mode, fix email binding in edit view, and remove photo column from directory index)
                        </div>
...
=======
                            <input type="date" name="date_of_birth" id="date_of_birth" 
                                   value="{{ old('date_of_birth', $dentist->date_of_birth ? \Carbon\Carbon::parse($dentist->date_of_birth)->format('Y-m-d') : '') }}" required
                                   class="mt-1 block w-full rounded-md bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                            @error('date_of_birth') <p class="text-red-500 dark:text-red-400 text-xs mt-1 font-medium">⚠️ {{ $message }}</p> @enderror
>>>>>>> 2ef7221 (Refactor dentist CRUD views for dynamic light/dark mode, fix email binding in edit view, and remove photo column from directory index)
                        </div>
...
=======
                                   class="mt-1 block w-full rounded-md bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                            @error('contact_no') <p class="text-red-500 dark:text-red-400 text-xs mt-1 font-medium">⚠️ {{ $message }}</p> @enderror
>>>>>>> 2ef7221 (Refactor dentist CRUD views for dynamic light/dark mode, fix email binding in edit view, and remove photo column from directory index)
                        </div>
                    </div>
...
=======
                        <input type="email" name="email_address" id="email_address" value="{{ old('email_address', $dentist->email) }}" required
                               class="mt-1 block w-full rounded-md bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                        @error('email_address') <p class="text-red-500 dark:text-red-400 text-xs mt-1 font-medium">⚠️ {{ $message }}</p> @enderror
>>>>>>> 2ef7221 (Refactor dentist CRUD views for dynamic light/dark mode, fix email binding in edit view, and remove photo column from directory index)
                    </div>
...
=======
                                  class="mt-1 block w-full rounded-md bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">{{ old('home_address', $dentist->home_address) }}</textarea>
                        @error('home_address') <p class="text-red-500 dark:text-red-400 text-xs mt-1 font-medium">⚠️ {{ $message }}</p> @enderror
>>>>>>> 2ef7221 (Refactor dentist CRUD views for dynamic light/dark mode, fix email binding in edit view, and remove photo column from directory index)
                    </div>
...
=======
                                  class="mt-1 block w-full rounded-md bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">{{ old('clinic_address', $dentist->clinic_address) }}</textarea>
                        @error('clinic_address') <p class="text-red-500 dark:text-red-400 text-xs mt-1 font-medium">⚠️ {{ $message }}</p> @enderror
                    </div>

                    <div class="flex items-center justify-end space-x-3 border-t border-gray-100 dark:border-gray-800 pt-4 mt-8">
                        <a href="{{ route('dentists.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-700 text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-150">
                            Cancel
                        </a>
                        <button type="submit" 
                                class="inline-flex justify-center items-center px-4 py-2 border border-transparent shadow-sm text-sm font-semibold rounded-md text-white bg-gray-700 dark:bg-indigo-600 hover:bg-gray-800 dark:hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition duration-150 cursor-pointer">
>>>>>>> 2ef7221 (Refactor dentist CRUD views for dynamic light/dark mode, fix email binding in edit view, and remove photo column from directory index)
