    ...
    <div class="py-12 bg-gray-100 dark:bg-[#030616] min-h-screen text-gray-900 dark:text-gray-100 transition-colors duration-200">
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            @if($role === 'admin')
                ...
                {{-- Admin Dashboard --}}
                <div class="bg-white dark:bg-gray-900 overflow-hidden shadow-xl sm:rounded-2xl p-6 border border-gray-200 dark:border-purple-900/40">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Use the navigation bar above to manage Chapter rows or provision administrative system accounts.
                    </p>
                    ...
                    <div class="flex flex-col md:flex-row items-center md:items-start gap-8">
                        ...
                        <div class="flex flex-col items-center shrink-0 space-y-3">
                            ...
                            @if(isset($profile))
                                ...
                                <form
                                    action="{{ route('member.update-photo') }}"
                                    method="POST"
                                ...
                                >
                                    ...
                                    <label
                                        for="portal_profile_image"
                                        class="inline-flex items-center px-3 py-1.5 border border-gray-300 dark:border-gray-700 shadow-sm text-xs font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition cursor-pointer"
                                    >
                                        📷 Update Photo
                                    </label>
                        ...
                        <div class="flex-1 w-full text-center md:text-left">
                            ...
                            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-medium text-purple-600 dark:text-purple-400 mt-0.5">
                                        Registered Chapter Member
                                    </p>
                                ...
                                <div>
                                    ...
                                    @if(isset($membership))
                                        ...
                                        <span class="inline-flex flex-col items-center md:items-end">
                                            ...
                                            <span class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">
                                                Fiscal Status ({{ $membership->membership_year }})
                                            </span>

                                            <span
                                                class="inline-flex items-center px-4 py-1.5 rounded-full text-sm font-semibold tracking-wide shadow-sm
                                                {{ Str::contains($membership->status, ['Active', 'Paid'])
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6 text-sm text-left">
                                ...
                                <div>
                                    ...
                                    <span class="block text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                                        PRC License Number
                                    </span>
