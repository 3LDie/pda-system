...
<body class="bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 antialiased min-h-screen flex flex-col selection:bg-purple-600 selection:text-white transition-colors duration-200">
    ...
    <!-- Main Content -->
    <main class="relative flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 w-full overflow-hidden">

        <!-- Background Logo -->
        <div class="absolute inset-0 flex justify-center pointer-events-none z-0 overflow-hidden">
            <img src="{{ asset('images/pda_logo.jpg') }}" alt="" class="absolute w-[700px] max-w-none opacity-[0.15] object-contain" style="top: 0px;">
        </div>
    ...
    <!-- Footer -->
    <footer class="bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 py-6">
