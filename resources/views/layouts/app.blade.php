...
<body
    ...
    data-dentist-mode="{{ $isDentistPage ? '1' : '0' }}"
>
    ...
    <div class="min-h-screen bg-gray-100 dark:bg-[#030616] text-slate-900 dark:text-slate-100 transition-colors duration-200">
        ...
        @endisset
 (improve authentication page and add the pda logo)
    ...
    @if(session('success') || $errors->any())
        ...
        >
            ...
            <div class="p-4 flex items-start gap-3">
                ...
                @if(session('success'))
                    <div class="flex-shrink-0 text-emerald-500 text-xl">
                        ✅
                    </div>
                ...
                @else
                    <div class="flex-shrink-0 text-rose-500 text-xl">
                        ⚠️
                    </div>

                    <div class="flex-1">
                        <p class="text-sm font-semibold text-gray-900 dark:text-gray-100">
                            Validation/Database Alert
                        </p>
                ...
                <button
                    @click="show = false"
                    class="text-gray-400 hover:text-gray-600 dark:text-gray-300 dark:hover:text-white transition focus:outline-none text-xs font-bold px-1 cursor-pointer"
                >
                    &times;
                </button>
