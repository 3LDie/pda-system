<nav x-data="{ open: false, darkMode: document.documentElement.classList.contains('dark') }" class="bg-white dark:bg-gray-700 border-b border-gray-100 dark:border-gray-600">
